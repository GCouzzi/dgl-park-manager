...
export const resourceConfigs = {
  ...
  entrada: {
    ...
    fields: [
      ...
      { name: 'vagaId', label: 'Vaga', type: 'select', required: true, optionSource: vagaSource },
  ...
  saida: {
    ...
    canDelete: true,
    fields: [
      { name: 'entradaId', label: 'Entrada', type: 'select', required: true, optionSource: entradaSource, readOnlyOnEdit: true },
