...
export default function RelatorioMediaSaida() {
  usePageTitle("Média por Saída");

  return (
    <AppShell role="funcionario" activeSection="relatorios" activeItem="/relatorio-media-saida">
    <main className="container-fluid flex-grow-1 d-flex flex-column">
      <div className="row flex-grow-1">
        <section className="col-12 p-5">
          <PageCard title="Média Gasta por Saída de Cada Usuário">
